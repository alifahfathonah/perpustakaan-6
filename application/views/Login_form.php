...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('asset/assets/font-awesome/4.5.0/css/font-awesome.min.css');?>" />

    <!-- text fonts -->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('asset/assets/css/fonts.googleapis.com.css');?>" />

    <!-- ace styles -->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('asset/assets/css/ace.min.css');?>" />

    <!--[if lte IE 9]>
      <link rel="stylesheet" href="asset/assets/css/ace-part2.min.css" />
    <![endif]-->
    <link rel="stylesheet" type="text/css " href="<?php echo base_url('asset/assets/css/ace-rtl.min.css');?>" />
                       ...
                       <?= form_open($form_action, ['name' => 'login_form', 'id' => 'login_form']); ?>
                        <fieldset>
                          ...
                          <div class="clearfix">
                            ...
                            <input type="submit" name="Login" class="btn btn-default submit" id="submit" value="Submit"/>
                          </div>
