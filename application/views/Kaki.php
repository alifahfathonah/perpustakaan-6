            ...
            <a href="<?php echo base_url(); ?>asset/#" id="btn-scroll-up" class="btn-scroll-up btn btn-sm btn-inverse">
        ...
        <!--[if IE]>
<script src="<?php echo base_url(); ?>asset/assets/js/jquery-1.11.3.min.js"></script>
<![endif]-->
        ...
        <!--[if lte IE 8]>
          <script src="<?php echo base_url(); ?>asset/assets/js/excanvas.min.js"></script>
        <![endif]-->
