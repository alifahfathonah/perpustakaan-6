...
<div class="title_left" align="center">
   <h3><small>Table peminjaman</small><br /></h3>
</div>

<div class="x_panel">
    <div class="x_title">
        <h2><i class="fa fa-bars"></i>Table peminjaman</h2>
    ...
    <div class="x_content">
        <div class="" role="tabpanel" data-example-id="togglable-tabs">
            <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                <li role="presentation" class="active"><?= anchor('peminjaman', 'List'); ?>
                </li>
                <li role="presentation" class=""><?= anchor('peminjaman/create', 'Form'); ?>
                </li>
            </ul>
        </div>
        <div class="x_panel">
        ...
        <?= form_close() ?>
						...
						<tbody>
							<?php foreach($peminjamans as $peminjaman): ?>
								<tr>
                                    ...
                                    <td><?= $peminjaman->is_kembali == 'y' ? "Sudah" : "Belum" ?></td>
                                    <td>
                                        <?= form_open("Peminjaman/delete"); ?>
                                            <?= form_hidden("id_pinjam", $peminjaman->id_pinjam) ?>
                ...
                <?= anchor("peminjaman/create", 'Tambah', ['class' => 'btn btn-success']) ?>
                </div>
